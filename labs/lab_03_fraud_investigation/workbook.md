...
Scale:
> What is the volume of transactions? Thousands per day or millions? How many analysts are working the queue?
Question: [blank]
Assumption: [blank]
...
Curveball 3: A regulator asks you to explain why the system flagged a specific transaction. How do you justify the score?
Your response:
[blank]
[blank]
[blank]
